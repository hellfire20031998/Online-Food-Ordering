...
public class FoodServiceImpl implements FoodService {
    ...
    public void deleteFood(Long foodId) throws Exception {
        ...
        // Remove any cart lines still pointing at this food before deleting it.
        cartItemRepository.deleteAll(cartItemRepository.findByFoodId(foodId));
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "This food appears in past orders and cannot be deleted; mark it unavailable instead");
        }
    }
    ...
    public Food findFoodById(Long foodId) throws Exception {
        return foodRepository.findById(foodId)
                .orElseThrow(() -> new FoodIdNotFoundException("Food with id " + foodId + " not found"));
    }
